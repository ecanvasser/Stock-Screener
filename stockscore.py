...
class Stock:
    ...
    def getScorePrice(tickers):
        ...
        final_stats = []
        for arg in args:
            # Gets JSON article data for ticker symbol. Make sure to input API key
            ...
            # Gets JSON stock price data. Make sure to input API key
            ...
            # Cleans text_tick by removing all repeated values. Only saves the unique values
            cleaned_text = []            
